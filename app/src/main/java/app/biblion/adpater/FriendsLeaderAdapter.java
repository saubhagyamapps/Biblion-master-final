...
public class FriendsLeaderAdapter extends RecyclerView.Adapter<FriendsLeaderAdapter.MyViewHolder> {

    Context context;
    int[] num;

    public FriendsLeaderAdapter(Context context, int[] num) {
    ...
    @NonNull
    @Override
    public FriendsLeaderAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.friends_leader_list,viewGroup,false);
        return new FriendsLeaderAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FriendsLeaderAdapter.MyViewHolder myViewHolder, int i) {
